...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var mSharedPreferenes: SharedPreferences
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSharedPreferenes = getSharedPreferences(Constants.PREFERENCE_NAME, Context.MODE_PRIVATE)
            ...
            listCall.enqueue(object : Callback<WeatherResponse> {
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        val editor = mSharedPreferenes.edit()
    ...
    private fun setupUI() {
        ...
        val weatherResponseJsonString = mSharedPreferenes.getString(Constants.WEATHER_RESPONSE_DATA,"")
